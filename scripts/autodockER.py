...
DISCO
|Gene
 |PDB (folder containing ligand-receptor complex files)
...
def main():
	...
	for f in files:
		...
		for fi in os.listdir():
			...
			# Concatenation of unchanged crystal structure with docking resulting .pdb file
			try:
		...
		#os.chdir("/home/noah/Desktop/refined-set")
